...
/**
 * 类功能简述： 线程池工厂，可使用此工厂创建线程池,等待队列使用：ArrayBlockingQueue 类功能详述：
 *
 * @author fanxb
...
public class ThreadPoolFactory {
    ...
    public static ThreadPoolExecutor createPool(String factoryName) {
        ...
        return createPool(DEFAULT_CORE_POOL_SIZE, DEFAULT_MAX_POOL_SIZE, DEFAULT_KEEP_ACTIVE_TIME, DEFAULT_QUEUE_LENGTH,
                threadFactory);
    }
     ...
     */
    public static ThreadPoolExecutor createPool(int corePoolSize, int maxPoolSize, long keepActiveTime, int queueLength,
            String threadName) {
        return new ThreadPoolExecutor(corePoolSize, maxPoolSize, keepActiveTime, TimeUnit.MILLISECONDS,
                new ArrayBlockingQueue<>(queueLength), new CustomThreadFactory(threadName));
    ...
    public static ThreadPoolExecutor createPool(int corePoolSize, int maxPoolSize, long keepActiveTime, int queueLength,
        ...
        return new ThreadPoolExecutor(corePoolSize, maxPoolSize, keepActiveTime, TimeUnit.MILLISECONDS,
                new ArrayBlockingQueue<>(queueLength), factory);
